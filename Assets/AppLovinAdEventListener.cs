...
public class AppLovinAdEventListener : MonoBehaviour
{
    ...
    void Start()
    {
        if (datetimer == "")
        {
            ...
            var url1 = "https://gamelovin.com/tradeoption/Trading/Userprocess/Gettimer";
    ...
    private IEnumerator PostRequestCoroutine(string url, string json)
    {
        ...
        else
        {
            ...
            {
               // GameObject tost = GameObject.Find("Canvas/Notify/NetworkErrorMessage");
                tost.transform.GetChild(0).GetComponent<Text>().text = "+10 Coins";
                tost.SetActive(true);
                StartCoroutine("hidenotify");
    ...
    void onAppLovinEventReceived(string ev)
    {
        ...
        if (string.Equals(ev, "HIDDENINTER") || string.Equals(ev, "VIDEOSTOPPED"))
        {
            ...
            string json1 = "{\"user_id\":\"" + PlayerPrefs.GetString("uniqueid") + "\",\"video_name\":\"AppLovin\",\"type\":\"1\",\"earn\":\"10\"}";
            StartCoroutine(PostRequestCoroutine(url1, json1));
            PlayerPrefs.SetFloat("Total", PlayerPrefs.GetFloat("Total") + 10);
